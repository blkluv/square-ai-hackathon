...
const ImageGrid = () => {
  ...
  //   return (
  //     <div className="w-100 mx-auto float-left"> {/* Set the container width to 100px */}
  //       <div className="grid grid-cols-4 gap-4">
  //         {imageFilenames.map((filename, index) => (
  //           <div key={index} className="w-1/4"> {/* Set each image to occupy 25% of the container width */}
  //             <img
  //               src={imageFilenames[index]} // Assuming your images are in the 'assets' folder
  //               alt={`Image ${index + 1}`}
  //               className="max-w-full h-auto" // Ensure images maintain their aspect ratio while fitting within their div
  //             />
  //           </div>
  //         ))}
  //       </div>
  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Sidenav"
      >
        <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 mb-[2vhclear] dark:border-gray-700">
          <ul class="space-y-2">
            <li>
              {/* <a
                href="/overview"
